...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4299: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4301: (a: number, b: number, c: number, d: number) => void;
